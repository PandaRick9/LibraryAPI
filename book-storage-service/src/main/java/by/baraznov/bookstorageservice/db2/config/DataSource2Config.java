package by.baraznov.bookstorageservice.db2.config;
...
@EnableJpaRepositories(entityManagerFactoryRef = "secondEntityMangerFactoryBean", basePackages = {
        "by.baraznov.bookstorageservice.db2.repository" }, transactionManagerRef = "secondTransactionManager")
public class DataSource2Config {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() {
        ...
        bean.setPackagesToScan("by.baraznov.bookstorageservice.db2.model");
